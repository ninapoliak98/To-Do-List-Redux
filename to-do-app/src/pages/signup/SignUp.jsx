  ...
  return (
    <div
      ...
      <form onSubmit={handleSubmit}
        className='flex flex-col py-14 px-12 border-2 border-shark-300 rounded-lg shadow-lg shadow-slate-300 w-[350px]'
      > <h1 className=" text-xl font-bold leading-tight tracking-tight text-shark-500 md:text-2xl mb-5">
          Don't Have an Account?
        </h1>
        <label
          className='block text-s font-semibold text-shark-500 mb-5'>
          Email
      ...
      <div className='mt-5'>
        <span className='text-gray-700'> Already have an account?</span>  <Link className='text-shark-300 hover:underline' to={LOGIN_ROUTE}>Login</Link>
      </div>
    </div>
